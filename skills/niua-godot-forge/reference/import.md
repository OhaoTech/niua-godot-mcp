...
| `list_imported_assets` | v1, full | List assets with Godot .import metadata under a res:// folder. | host:string, port:number, expectedProjectRoot:string, path:string, recursive:boolean |
