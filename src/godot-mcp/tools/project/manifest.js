...
export const PROJECT_DISCOVERY_TOOL_MANIFEST = [
  {
    ...
    description: "Scan allowlisted filesystem roots for Godot project.godot files and optionally remember them. Directories are walked in sorted name order, so results list deterministically.",
    profile: "full",
    tier: "standard",
    category: "project-management",
    implementation: "local",
